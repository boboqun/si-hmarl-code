...
与 advanced_enjoy.py 的核心差异：
    ...
    ⑤ 默认 Checkpoint 目录为 ../results/sa_hmarl_staggered/checkpoints/

运行：
    python hierarchical_enjoy.py
    python hierarchical_enjoy.py --checkpoint ./../results/sa_hmarl_staggered/checkpoints
"""
...
def main():
    ...
    parser.add_argument(
        "--checkpoint",
        type=str,
        default=os.path.join(PROJECT_DIR, "../results/sa_hmarl_staggered/checkpoints"),
        help="Checkpoint 目录（默认: ./../results/sa_hmarl_staggered/checkpoints）",
    )
